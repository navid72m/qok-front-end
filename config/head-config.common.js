...
module.exports = {
  link: [
    ...
    { rel: 'icon', type: 'image/jpg', sizes: '16x16', href: '/assets/icon/qok.jpg' },
   ...
   // { rel: 'stylesheet', href: 'https://fonts.googleapis.com/icon?family=Material+Icons' },
    { rel: 'stylesheet', href: '/assets/Material+Icons.css' },

    /** primeng required files **/
    // { rel: 'stylesheet', type: "text/css", href: "/node_modules/primeng/resources/themes/omega/theme.css" },
    // { rel: 'stylesheet', type: "text/css", href: "/node_modules/primeng/resources/primeng.min.css" },
    // <link rel="stylesheet" type="text/css" href="YOUR_PATH/font-awesome.min.css" />
    // <link rel="stylesheet" type="text/css" href="/node_modules/primeng/resources/primeng.min.css" />
    // { rel: 'stylesheet', href: '../node_modules/@angular/material/prebuilt-themes/indigo-pink.css"' }
  ],
  meta: [
